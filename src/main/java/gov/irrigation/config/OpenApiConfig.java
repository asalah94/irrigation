...
@Configuration
@OpenAPIDefinition(servers = {@Server(url = "/", description = "Default Server URL"), @Server(url = "/user-administration-service", description = "Server URL")})
public class OpenApiConfig {
    ...
    public OpenAPI customOpenAPI(@Value("${spring.application.name}") String title, @Value("${spring.application.name}") String description) {
    	String contactEmail = "nour.shaheen@wscdev.net";
